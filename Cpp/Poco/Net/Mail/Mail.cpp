...
int main(int argc, char** argv)
{
	...
	try
	{
		...
		std::string attachment = Path::expand("/mnt/home2/51linux_LxomB0aQ/MyProgram/MyGit/Cpp/Poco/Net/Mail/1.html");
		message.addAttachment("1", new StringPartSource(attachment, "text/plain", "1.html"));
